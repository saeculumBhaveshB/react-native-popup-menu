...
// import BedLayout from './src/components/bed/BedLayout';

// import bedLayouts from './src/components/bed/bedLayouts.json';
...
import BedGrid from './src/components/bed/BedGrid';
...
const data = {
  ward: {
    ...
    occupiedBeds: 0,
    bedLayouts: [
      { rowNumber: 1, columnNumber: 1, bedNumber: 'E1', status: 'AVAILABLE' },
      { rowNumber: 1, columnNumber: 2, bedNumber: 'E2', status: 'AVAILABLE' },
      { rowNumber: 2, columnNumber: 1, bedNumber: 'E3', status: 'AVAILABLE' },
      { rowNumber: 2, columnNumber: 2, bedNumber: 'E4', status: 'AVAILABLE' },
      { rowNumber: 1, columnNumber: 3, bedNumber: 'SPL', status: 'AVAILABLE' },
      { rowNumber: 3, columnNumber: 1, bedNumber: 'SP1', status: 'AVAILABLE' },
      { rowNumber: 3, columnNumber: 2, bedNumber: 'SP2', status: 'AVAILABLE' },
      { rowNumber: 4, columnNumber: 1, bedNumber: 'SP3', status: 'AVAILABLE' },
      { rowNumber: 4, columnNumber: 3, bedNumber: 'SP4', status: 'AVAILABLE' },
    ],
  },
};
...
export default function App() {
  return (
    <SafeAreaView style={{ flex: 1 }}>
      {/* Pass only bedLayouts array to BedGrid */}
      <BedGrid beds={data.ward.bedLayouts} />
    </SafeAreaView>
  );
}
